...
from models.models import CreateConversationRequest, CreateMessageRequest
...
async def id_exists(id: str, field: str, table: str):
    try:
        ...
        print(f"Error checking ID {id} in field {field} for table {table}: {e}")
...
async def create_conversation(request: CreateConversationRequest):
    try:
        ...
        while id_exists(new_uuid, 'conversation_id', 'conversations'):
            new_uuid = str(uuid.uuid4())
...
'''
async def create_message_conversation(request: CreateMessageRequest):
   pass
